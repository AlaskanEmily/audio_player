...
:- type buffer.
:- type bytes.
:- func init(int::in) = (buffer::uo) is det.
:- func length(buffer) = (int).
:- func bytes(buffer) = bytes.
...
:- pragma foreign_type("C", bytes, "const void*").
:- pragma foreign_type("Java", bytes, "byte[]").
...
:- pragma foreign_proc("C", init(Size::in) = (Buffer::uo),
...
:- pragma foreign_proc("Java", init(Size::in) = (Buffer::uo),
    [will_not_call_mercury, will_not_throw_exception, promise_pure, thread_safe, tabled_for_io],
    "
...
:- pragma foreign_proc("C", bytes(Buffer::in) = (Bytes::out),
    [will_not_call_mercury, will_not_throw_exception, promise_pure, thread_safe,
    does_not_affect_liveness], " Bytes = Buffer->data; ").

:- pragma foreign_proc("Java", bytes(Buffer::in) = (Bytes::out),
    [will_not_call_mercury, will_not_throw_exception, promise_pure, thread_safe,
    does_not_affect_liveness], " Bytes = Buffer; ").
